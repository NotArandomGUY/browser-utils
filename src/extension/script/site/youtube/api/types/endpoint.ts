...
export enum YTSignalActionType {
  ...
  BU_MOD_DELAYED_PLAY_PLAYER = 'BU_MOD_DELAYED_PLAY_PLAYER',
  BU_MOD_SHORTS_HIDE = 'BU_MOD_SHORTS_HIDE',
  BU_MOD_SHORTS_SHOW = 'BU_MOD_SHORTS_SHOW',
  BU_MOD_LIVE_HIDE = 'BU_MOD_LIVE_HIDE',
  BU_MOD_LIVE_SHOW = 'BU_MOD_LIVE_SHOW',
  BU_MOD_VIDEO_HIDE = 'BU_MOD_VIDEO_HIDE',
  BU_MOD_VIDEO_SHOW = 'BU_MOD_VIDEO_SHOW'
}

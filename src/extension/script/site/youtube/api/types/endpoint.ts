...
export enum YTSignalActionType {
  ...
  MOD_DELAYED_PLAY_PLAYER = 'MOD_DELAYED_PLAY_PLAYER',
  MOD_SHORTS_HIDE = 'MOD_SHORTS_HIDE',
  MOD_SHORTS_SHOW = 'MOD_SHORTS_SHOW',
  MOD_LIVE_HIDE = 'MOD_LIVE_HIDE',
  MOD_LIVE_SHOW = 'MOD_LIVE_SHOW',
  MOD_VIDEO_HIDE = 'MOD_VIDEO_HIDE',
  MOD_VIDEO_SHOW = 'MOD_VIDEO_SHOW',
  MOD_LIVE_BEHAVIOUR_NORMAL = 'MOD_LIVE_BEHAVIOUR_NORMAL',
  MOD_LIVE_BEHAVIOUR_LOW_LATENCY = 'MOD_LIVE_BEHAVIOUR_LOW_LATENCY'
}

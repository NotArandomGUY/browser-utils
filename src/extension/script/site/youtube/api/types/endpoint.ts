...
export enum YTSignalActionType {
  ...
  BU_UIMOD_SHORTS_HIDE = 'BU_UIMOD_SHORTS_HIDE',
  BU_UIMOD_SHORTS_SHOW = 'BU_UIMOD_SHORTS_SHOW',
  BU_UIMOD_LIVE_HIDE = 'BU_UIMOD_LIVE_HIDE',
  BU_UIMOD_LIVE_SHOW = 'BU_UIMOD_LIVE_SHOW',
  BU_UIMOD_VIDEO_HIDE = 'BU_UIMOD_VIDEO_HIDE',
  BU_UIMOD_VIDEO_SHOW = 'BU_UIMOD_VIDEO_SHOW'
}

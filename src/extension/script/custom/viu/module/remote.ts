import { playerGetCurrentTime, playerGetDuration, playerGetMute, playerGetSubtitle, playerGetVolume, playerIsPlaying, playerPause, playerPlay, playerSeek, playerSetMute, playerSetVolume } from '@ext/custom/viu/module/player'

import McdBridge from '@ext/custom/mcdonalds/bridge'
...
import McdLocationPlugin, { type McdLocationData } from '@ext/custom/mcdonalds/plugins/location'
import McdSystemPlugin from '@ext/custom/mcdonalds/plugins/system'
import McdUserPlugin, { type McdUserData } from '@ext/custom/mcdonalds/plugins/user'

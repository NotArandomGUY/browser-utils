export enum CommentPollStatus {
  COMMENT_POLL_STATUS_NO_VOTE = 'COMMENT_POLL_STATUS_NO_VOTE',
  COMMENT_POLL_STATUS_VOTE_NO_COMMENT = 'COMMENT_POLL_STATUS_VOTE_NO_COMMENT'
}

export enum EngagementType {
  ENGAGEMENT_TYPE_PLAYBACK = 'ENGAGEMENT_TYPE_PLAYBACK',
  ENGAGEMENT_TYPE_POST_POLL_VOTE = 'ENGAGEMENT_TYPE_POST_POLL_VOTE',
  ENGAGEMENT_TYPE_SHARE = 'ENGAGEMENT_TYPE_SHARE',
  ENGAGEMENT_TYPE_UNBOUND = 'ENGAGEMENT_TYPE_UNBOUND',
  ENGAGEMENT_TYPE_VIDEO_TRANSCRIPT_REQUEST = 'ENGAGEMENT_TYPE_VIDEO_TRANSCRIPT_REQUEST',
  ENGAGEMENT_TYPE_YPC_GET_DOWNLOAD_ACTION = 'ENGAGEMENT_TYPE_YPC_GET_DOWNLOAD_ACTION',
  ENGAGEMENT_TYPE_YPC_GET_PREMIUM_PAGE = 'ENGAGEMENT_TYPE_YPC_GET_PREMIUM_PAGE'
}
...
export enum MusicVideoType {
  ...
  MUSIC_VIDEO_TYPE_PRIVATELY_OWNED_TRACK = 'MUSIC_VIDEO_TYPE_PRIVATELY_OWNED_TRACK',

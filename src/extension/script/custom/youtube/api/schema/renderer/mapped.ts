...
export const textViewModel = ytv_rvm(() => ({
  ...
  commandRuns: ytv_arr(ytv_ren({
    length: ytv_num(),
    onTap: ytv_enp(),
    onTapOptions: ytv_sto({
      accessibilityInfo: ytv_sto({
  ...
  decorationRuns: ytv_arr(ytv_ren({
    textDecorator: ytv_sto({
      highlightTextDecorator: ytv_sto({
        backgroundCornerRadius: ytv_num(),
        bottomPadding: ytv_num(),
        highlightTextDecoratorExtensions: ytv_sto({
...
export const adPlacementRenderer = ytv_ren(() => ({
  ...
  config: ytv_sto({
    adPlacementConfig: ytv_sto({
      adTimeOffset: ytv_sto({
...
export const adSlotRenderer = ytv_ren(() => ({
  ...
  fulfillmentContent: ytv_sto({
    fulfilledLayout: ytv_ren()
  }),
  slotEntryTrigger: ytv_sto({
    beforeContentVideoIdStartedTrigger: ytv_unk(),
    id: ytv_str(),
    layoutExitedForReasonTrigger: components.layoutExitedForReasonTrigger,
    layoutIdEnteredTrigger: ytv_sto({
      triggeringLayoutId: ytv_str()
    })
  }),
  slotExpirationTriggers: ytv_arr(ytv_sto({
    id: ytv_str(),
    layoutExitedForReasonTrigger: components.layoutExitedForReasonTrigger,
    onNewPlaybackAfterContentVideoIdTrigger: ytv_unk(),
    slotIdExitedTrigger: ytv_sto({
      triggeringSlotId: ytv_str()
    })
  })),
  slotFulfillmentTriggers: ytv_arr(ytv_sto({
    id: ytv_str(),
    slotIdEnteredTrigger: ytv_sto({
      triggeringSlotId: ytv_str()
    }),
    slotIdScheduledTrigger: ytv_sto({
      triggeringSlotId: ytv_str()
    })
  }))
}))
...
export const backstagePostRenderer = ytv_ren(() => ({
  ...
  surface: ytv_str(['BACKSTAGE_SURFACE_TYPE_STREAM']),
  voteCount: components.text,
  voteStatus: ytv_str(common.enums.LikeStatus)
}))
export const backstagePostThreadRenderer = ytv_ren(() => ({
  post: ytv_ren(),
  useUpdatedRepostUi: ytv_bol()
}))
...
export const cinematicContainerRenderer = ytv_ren(() => ({
  config: ytv_sto({
    ...
    watchFullscreenConfig: ytv_sto({
      colorSourceWidthMultiplier: ytv_num(),
      colorSourceHeightMultiplier: ytv_num(),
      flatScrimColor: ytv_num(),
      scrimGradientConfig: ytv_sto({
        gradientColors: ytv_arr(ytv_sto({
  ...
  gradientColorConfig: ytv_arr(ytv_sto({
    darkThemeColor: ytv_num(),
    startLocation: ytv_num()
  })),
...
export const expandableMetadataRenderer = ytv_ren(() => ({
  ...
  colorData: ytv_sto({
    ...
    saturatedColorPalettes: ytv_sto({
...
export const horizontalListRenderer = ytv_ren(() => ({
  ...
  force16By9ThumbnailAspectRatio: ytv_bol(),
...
export const liveChatChannelGuidelinesDialogRenderer = ytv_ren(() => ({
  ackButton: ytv_ren(),
  channelGuidelines: ytv_arr(components.text),
  channelOwnerAvatar: components.thumbnail,
  channelOwnerDisplayName: components.text,
  communityGuidelines: components.text,
  title: components.text,
  welcomeMessage: components.text
}))
...
export const liveChatMessageInputRenderer = ytv_ren(() => ({
  authorName: components.text,
  authorPhoto: components.thumbnail,
  beforeFocusCommand: ytv_enp(),
  emojiPickerButton: ytv_ren(),
  inputField: ytv_ren(),
  onInitialFocusCommand: ytv_enp(),
...
export const liveChatRenderer = ytv_ren(() => ({
  ...
  enableCreatorWebBannerRelocation: ytv_bol(),
...
export const notificationRenderer = ytv_ren(() => ({
  contextualMenu: ytv_ren(),
  navigationEndpoint: ytv_enp(),
  notificationId: ytv_str(),
  read: ytv_bol(),
  recordClickEndpoint: ytv_enp(),
  sentTimeText: components.text,
  shortMessage: components.text,
  thumbnail: components.thumbnail,
  videoThumbnail: components.thumbnail
}))
...
export const playerAttestationRenderer = ytv_ren(() => ({
  botguardData: ytv_sto({
    interpreterSafeUrl: ytv_sto({
      privateDoNotAccessOrElseTrustedResourceUrlWrappedValue: ytv_str()
    }),
    program: ytv_str(),
...
export const playerBytesAdLayoutRenderer = ytv_ren(() => ({
  adLayoutMetadata: components.adLayoutMetadata,
  layoutExitMuteTriggers: ytv_arr(ytv_sto({
    id: ytv_str(),
    skipRequestedTrigger: ytv_sto({
      triggeringLayoutId: ytv_str()
    })
  })),
...
export const playerCaptionsTracklistRenderer = ytv_ren(() => ({
  ...
  translationLanguages: ytv_arr(ytv_sto({
    languageCode: ytv_str(),
...
export const pollRenderer = ytv_ren(() => ({
  accessibilityData: common.components.accessibility,
  choices: ytv_arr(ytv_sto({
    deselectServiceEndpoint: ytv_enp(),
    numVotes: ytv_str(),
    selectServiceEndpoint: ytv_enp(),
    selected: ytv_bol(),
    text: components.text,
    votePercentage: components.text,
    votePercentageIfNotSelected: components.text,
    votePercentageIfSelected: components.text,
    voteRatio: ytv_num(),
    voteRatioIfNotSelected: ytv_num(),
    voteRatioIfSelected: ytv_num(),
  })),
  header: ytv_ren(),
  liveChatPollId: ytv_str(),
  totalVotes: components.text,
  type: ytv_str(enums.PollType)
}))
...
export const quizRenderer = ytv_ren(() => ({
  accessibilityData: common.components.accessibility,
  choices: ytv_arr(ytv_ren({
    deselectServiceEndpoint: ytv_enp(),
    explanation: components.text,
    isCorrect: ytv_bol(),
    isSelected: ytv_bol(),
    selectServiceEndpoint: ytv_enp(),
    text: components.text
  })),
  correctVotedText: components.text,
  enableAnimation: ytv_bol(),
  explanationCollapseText: components.text,
  explanationExpandText: components.text,
  explanationHeaderText: components.text,
  totalVotes: components.text,
  type: ytv_str(enums.PollType),
  votedText: components.text
}))
...
export const richGridRenderer = ytv_ren(() => ({
  ...
  style: ytv_str(['RICH_GRID_STYLE_SHORTS_GRID', 'RICH_GRID_STYLE_SLIM']),
  targetId: ytv_str()
}))
export const richItemRenderer = ytv_ren(() => ({
  content: ytv_ren(),
  onFocusEffect: ytv_sto({
    onFocusColor: ytv_sto({
      darkTheme: ytv_num(),
      lightTheme: ytv_num()
    }),
    onFocusStyle: ytv_str(['ON_FOCUS_STYLE_BACKGROUND']),
    textPrimaryColor: ytv_sto({
      darkTheme: ytv_num(),
      lightTheme: ytv_num()
    }),
    textSecondaryColor: ytv_sto({
      darkTheme: ytv_num(),
      lightTheme: ytv_num()
    }),
    touchResponseColor: ytv_sto({
      darkTheme: ytv_num(),
      lightTheme: ytv_num()
    })
  })
...
export const subscribeButtonRenderer = ytv_ren(() => ({
  ...
  style: ytv_sto({
    styleType: ytv_str(['COMPACT_GRAY'])
  }),
...
export const toggleButtonRenderer = ytv_ren(() => ({
  ...
  toggleButtonSupportedData: ytv_sto({
    toggleButtonIdData: ytv_sto({
...
export const topicLinkRenderer = ytv_ren(() => ({
  callToActionIcon: components.icon,
  thumbnailDetails: components.thumbnail,
  title: components.text
}))
...
export const videoDescriptionCourseSectionRenderer = ytv_ren(() => ({
  mediaLockups: ytv_arr(ytv_ren()),
...
export const badgeViewModel = ytv_rvm(() => ({
  badgeStyle: ytv_str(['BADGE_COMMERCE', 'BADGE_DEFAULT', 'BADGE_MEMBERS_ONLY', 'BADGE_PROMOTED']),
  badgeText: ytv_str(),
  iconName: ytv_str(enums.IconType)
}))
export const basicContentViewModel = ytv_rvm(() => ({
  paragraphs: ytv_arr(ytv_sto({
    text: textViewModel
  }))
}))
export const bkaEnforcementMessageViewModel = ytv_rvm(() => ({
  bulletList: ytv_sto({
    bulletListItems: ytv_arr(ytv_sto({
      title: textViewModel
    }))
  }),
...
export const chipViewModel = ytv_rvm(() => ({
  accessibilityLabel: ytv_str(),
  chipEntityKey: ytv_str(),
  displayType: ytv_str(['CHIP_VIEW_MODEL_DISPLAY_TYPE_DROP_DOWN', 'CHIP_VIEW_MODEL_DISPLAY_TYPE_UNSPECIFIED']),
  selected: ytv_bol(),
  tapCommand: ytv_enp(),
  text: ytv_str()
}))
...
export const contentMetadataViewModel = ytv_rvm(() => ({
  delimiter: ytv_str(),
  metadataRows: ytv_arr(ytv_sto({
    badges: ytv_arr(ytv_ren()),
    lockupContentMetadataRowExtension: ytv_sto({
      contentType: ytv_str(['METADATA_ROW_CONTENT_TYPE_DESCRIPTION'])
    }),
    metadataParts: ytv_arr(ytv_sto({
      accessibilityLabel: ytv_str(),
      avatarStack: ytv_ren(),
...
export const featuredActionViewModel = ytv_rvm(() => ({
  ...
  videoPlaybackTimeoutTimeMs: ytv_sto({
    streamTimeMillis: ytv_str()
  }),
  videoPlaybackTriggerTimeMs: ytv_sto({
    streamTimeMillis: ytv_str()
  })
}))
...
export const flexibleActionsViewModel = ytv_rvm(() => ({
  ...
  justifyContent: ytv_str(['FLEXIBLE_ACTIONS_JUSTIFY_CONTENT_START', 'FLEXIBLE_ACTIONS_JUSTIFY_CONTENT_END', 'FLEXIBLE_ACTIONS_JUSTIFY_CONTENT_EVENLY']),
...
export const segmentedLikeDislikeButtonViewModel = ytv_rvm(() => ({
  ...
  dynamicLikeCountUpdateData: ytv_sto({
...
export const subscribeButtonViewModel = ytv_rvm(() => ({
  ...
  buttonStyle: ytv_sto({
    ...
    subscribeButtonAnimationStyle: ytv_str(['SUBSCRIBE_BUTTON_VIEW_MODEL_ANIMATION_STYLE_CAIRO']),
  ...
  notificationStateEntityStoreKeys: ytv_sto({
...
export const thumbnailBadgeViewModel = ytv_rvm(() => ({
  ...
  icon: components.image,
  inlinePlaybackBadgeData: ytv_sto({
...
export const timelyActionViewModel = ytv_rvm(() => ({
  additionalTrigger: ytv_arr(ytv_sto({
    args: ytv_sto({

import { ADBLOCK_STATIC_FILTER_URL_BLOCK_LIST } from '@ext/common/adblock/filter/static'
...
export default {
  ...
  networkRules: ADBLOCK_STATIC_FILTER_URL_BLOCK_LIST.map(urlFilter => new ScriptNetRule({

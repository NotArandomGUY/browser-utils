...
const FORBID_PATTERNS = [
  [buildHostnameRegexp(['adsrvr.org']), /./]
...
export default class AdblockNetworkModule extends Feature {
  public constructor() {
    super('network')
  }

  protected activate(): boolean {
    sendMessageToWorker(ExtensionMessageType.PACKAGE_SCRIPT_NET_RULE, { scriptId: 'adblock', includeDomain: [location.host], excludeDomain: [] })
  ...
  protected deactivate(): boolean {
    sendMessageToWorker(ExtensionMessageType.PACKAGE_SCRIPT_NET_RULE, { scriptId: 'adblock', includeDomain: [], excludeDomain: [location.host] })
